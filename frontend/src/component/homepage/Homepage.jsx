    ...
    return(
        <ThemeProvider theme={theme}>
            ...
            <Grid container spacing={2}>
                <Grid item xs={4}>
                    <img className="gambarutama" src="/assets/tuguyoung.png" height="500rem" style={{marginTop:'6.5vw', marginLeft:'12vw', marginBottom:'5vw'}} ></img>
                </Grid>
                <Grid item xs={8}>
            <div className="test" style={{marginTop: '10vw', marginRight:'10vw', marginLeft:'5vw'}}>
                <div className="judul">
                    <h1>KPGTS 2022</h1>
                </div>
